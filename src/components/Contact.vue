...
<template lang="pug">
  section.section.contact
    .section__container
      ...
      .spread-block
        .spread-block__col.spread-block__col--left.overview__content(v-scroll-reveal)
          .typographic(v-html="content.common.contact_content")
        .spread-block__col.spread-block__col--middle.overview__content(v-scroll-reveal)
        ...
        .spread-block__col.spread-block__col--right.overview__content(v-scroll-reveal)
    ...
    mq-layout(mq="lg+", v-scroll-reveal).section__mountain.section__mountain--6-3.section__mountain--l-n-n
      icon(glyph="mountain-group-6-3")
    mq-layout(mq="lg+", v-scroll-reveal).section__mountain.section__mountain--6-2.section__mountain--l-n
      icon(glyph="mountain-group-6-2")
    mq-layout(mq="lg+", v-scroll-reveal).section__mountain.section__mountain--6-1.section__mountain--l-n-n
